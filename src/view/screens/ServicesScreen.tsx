      ...
      <View style={styles.header}>
          ...
          {categories.map((cat) => (
            ...
            >
              <Ionicons 
                ...
                size={16} 
                color={activeFilter === cat.id ? '#FFF' : '#E53935'} 
              />
              <Text style={[
        ...
        >
          <View style={styles.petSelectorLeft}>
            <Ionicons name="paw" size={20} color="#E53935" />
            <View>
          ...
          {displayBath.length > 0 && (
            <>
              ...
              <FlatList
                data={displayBath}
                renderItem={renderService}
                keyExtractor={(item) => `bath-${item.id}`}
                scrollEnabled={false}
              />
            </>
          )}
        ...
        <View style={styles.modalOverlay}>
          <View style={styles.modalContent}>
            ...
            {pets.map((pet) => (
              ...
              >
                <Ionicons name="paw" size={24} color="#E53935" />
                <Text style={styles.petOptionText}>
                  {pet.name} - {pet.breed}
                </Text>

                {selectedPet?.id === pet.id && (
                  <Ionicons name="checkmark" size={24} color="#E53935" />
                )}
              </TouchableOpacity>
            ))}
...
const styles = StyleSheet.create({
  ...
  clearBadge: {
    flexDirection: 'row',
    alignItems: 'center',
    backgroundColor: '#FFEBEE', // Vermelho bem clarinho
    paddingHorizontal: 10,
    paddingVertical: 6,
    borderRadius: 20,
    borderWidth: 1,
